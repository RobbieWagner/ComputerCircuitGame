...
//     version 1.7.0
//     from Assets/Scripts/RobbieWagnerGames/UIInteraction.inputactions
//
...
public partial class @UIInteraction: IInputActionCollection2, IDisposable
{
    ...
    {
        private @UIInteraction m_Wrapper;
        public UIActions(@UIInteraction wrapper) { m_Wrapper = wrapper; }
